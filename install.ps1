param([ValidateSet('codex','claude-code','cursor','antigravity')][string]$Target = 'codex', [string]$ArchiveUrl = '')
$Prefix = 'PLUGLAYER'
if (!$ArchiveUrl) { $ArchiveUrl = 'https://github.com/pluglayer/codex-plugin/archive/refs/heads/main.zip' }
