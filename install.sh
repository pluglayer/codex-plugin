...
COMMON_URL="${PLUGLAYER_INSTALL_COMMON_URL:-https://raw.githubusercontent.com/pluglayer/codex-plugin/main/install-common.sh}"
ARCHIVE_URL="${PLUGLAYER_REPO_ARCHIVE_URL:-https://github.com/pluglayer/codex-plugin/archive/refs/heads/main.tar.gz}"
