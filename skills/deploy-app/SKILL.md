...
5. Check compute availability.
   ...
   - If compute is missing or zero, call `estimate_compute`, offer PlugLayer compute, share the PlugLayer link for getting or purchasing compute, and stop deployment until the user completes that step.
